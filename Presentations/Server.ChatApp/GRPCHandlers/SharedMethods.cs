...
public static class SharedMethods {
    public static async Task<AppUser> GetUserAsync(ServerCallContext context , IChatUOW unitOfWork) {
    ...
    public static async Task<Guid> GetUserIdAsync(ServerCallContext ctx , IChatUOW unitOfWork) => ( await GetUserAsync(ctx,unitOfWork) ).Id;
    //======================
}
